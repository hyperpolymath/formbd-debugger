...
* link:https://github.com/hyperpolymath/fqldt[FQLdt] - Dependently-typed Form Query Language
* link:https://github.com/hyperpolymath/formdb-studio[FormDB Studio] - Visual interface for FormDB
